...
class Img_DataSet(Dataset):
    ...
    def recompone_result(self):
        ...
        full_prob = torch.zeros((self.n_labels, self.padding_shape[0], 128,128))  # itialize to zero mega array with sum of Probabilities
        full_sum = torch.zeros((self.n_labels, self.padding_shape[0], 128, 128))
