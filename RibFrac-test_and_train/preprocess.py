        ...
        for ct_file,i in zip(file_list,range(Numbers)):
            try:
                ...
                if new_ct != None and new_seg != None:
                    ...
                    sitk.WriteImage(new_seg, os.path.join(self.fixed_path, 'label', ct_file.replace('image', 'label')))
            except IndexError:
                continue
...
if __name__ == '__main__':
    raw_dataset_path = './Homework_rawdata'
    fixed_dataset_path = './Homework_fixed_data_new'
